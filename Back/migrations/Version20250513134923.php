 ...
 */
final class Version20250513134923 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE tweet (id INT AUTO_INCREMENT NOT NULL, usr_id INT NOT NULL, content VARCHAR(280) NOT NULL, INDEX IDX_3D660A3BC69D3FB (usr_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
